...
public class LandController extends BaseController
{
	...
	@PostMapping("/list")
	@ResponseBody
	public TableDataInfo list(Land land, ModelMap map, String assetName)
	{
		startPage();
	...
	@PostMapping("/add")
	@ResponseBody
	public AjaxResult addSave(Land land)
	{		
	...
	{
		Land land = landService.selectLandById(id);
		mmap.put("land", land);
	    return prefix + "/edit";
	}
	...
	@PostMapping("/edit")
	@ResponseBody
	public AjaxResult editSave(Land land)
	{		
