package zjnu.newrailway.project.monitor.bean;




import zjnu.newrailway.common.utils.AddressUtils;
import zjnu.newrailway.framework.web.BaseEntity;
import zjnu.newrailway.project.monitor.bean.OnlineSession.OnlineStatus;
...
public class UserOnline extends BaseEntity
{
    ...
    public String toString()
    {
        return "UserOnline [sessionId=" + sessionId + ", deptName=" + deptName + ", loginName=" + loginName
                + ", ipaddr=" + ipaddr + ", loginLocation=" + loginLocation +", browser=" + browser + ", os=" + os + ", startTimestamp=" + startTimestamp
